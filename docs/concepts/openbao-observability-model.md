...
| Observed fixture behavior | The OpenBao 2.7.0 fixtures in this repository exercise HA/Raft metrics, audit streams, and both supported metric-prefix variants. |
