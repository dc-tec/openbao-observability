...
| Observed fixture behavior | The OpenBao 2.7.0 HA fixture exercises active state, unseal state, peer metrics, Autopilot health, Raft storage stats, three voters, and one non-voter read replica. |
